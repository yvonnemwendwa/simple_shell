...
"       If no argument is given to the cd command will be interpreted\n"\
"       as cd $HOME.\n"\
...
"       Exits the shell with a status of N.  If N is omitted, the exit stat\n"\
...
"       specified, gives detailed help on commands matching [BUILTIN_NAME],\n"\
